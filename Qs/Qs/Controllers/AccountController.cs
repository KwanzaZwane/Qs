...
namespace Qs.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> AddBranch(AddBranchViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, EmailConfirmed = true ,BranchGoogleId = model.BranchGoogleId, BranchLocation = model.BranchLocation, BranchName = model.BranchName};
